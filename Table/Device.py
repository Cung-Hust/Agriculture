...
class Device:
    def __init__(self, metadata: MetaData):
        self.device = Table('Device', metadata,
                            ...
                            Column('Timeslot', Integer),
                            Column('RelayCurrent', Boolean),
                            Column('DimCurrent', Integer),
                            Column('SceneCurrent', Integer),
                            Column('CosCurrent', Float),
                            Column('VCurrent', Float),
                            Column('ICurrent', Float),
                            Column('PCurrent', Float),
                            Column('KWhCurrent', Float),
                            Column('TCurrent', Float),
                            Column('LuxCurrent', Float)
                            )
